...
class MicropostsInterfaceTests < MicropostsInterface
  ...
  test 'should have a micropost delete links on own profile page' do
    get users_path(@user)
...
class ImageUploadTest < MicropostsInterface
  ...
  test 'should be able to attach an image' do
    ...
    post microposts_path, params: { micropost: { content:, image: img } }
